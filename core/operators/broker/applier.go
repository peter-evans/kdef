...
func (a *applier) apply() error {
	...
	if a.ops.pending() {
		...
		log.InfoMaybeWithKey("dry-run", a.opts.DryRun, "Completed apply for broker %q", a.localDef.Metadata.Name)
	} else {
...
func (a *applier) updateConfigs() error {
	...
	if err := a.srv.AlterBrokerConfigs(
		...
		log.InfoMaybeWithKey("dry-run", a.opts.DryRun, "Altered configs for broker %q", a.localDef.Metadata.Name)
	}

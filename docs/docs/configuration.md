...
When executing kdef, the AWS SDK must be instructed as to where credentials can be sourced. See [here](https://docs.aws.amazon.com/sdk-for-go/v2/developer-guide/configure-gosdk.html/) for further documentation.
